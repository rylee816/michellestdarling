  ...
  return (
    <div className="Title-main">
      <header className="Title">
        ...
        <a href="https://facebook.com/paintingsbymichellewilliams" target="_blank"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
        <a href="https://instagram.com/artbymwilliams" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a>
        <a href="https://etsy.com/shop/darlingvintageandart" target="_blank"><i class="fa fa-etsy" aria-hidden="true"></i></a>
        </div>
      <Gallery />
    </div>
  );
